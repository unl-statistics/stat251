...
You're ready to finish up the homework on data manipulation
...
Extra credit opportunity: what went wrong with the data processing for the homework?

Identify the problem and provide an updated version of the data based on data from [gapminder](https://www.gapminder.org/data/)


# Next time

- Working with Strings! - Poems are data too :)
